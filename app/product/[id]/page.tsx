...
export default function ZhenProduct() {
  ...
  const WA_URL = 'https://wa.me/919266442898?text=Hi%2C%20I%20am%20interested%20in%20ZHEN%20Noodles.';
    ...
    <div className="root">
      ...
      <div className="breadcrumb-bar">
        <div className="container breadcrumb-inner">
          ...
          <span>→</span>
          <span className="bc-current">Zhen Noodles</span>
        </div>
      </div>
        ...
        <div className="container product-hero__inner">
          ...
          <div className="product-hero__visual reveal">
            <div className="product-images-showcase">
              <img src="/front.jpeg" alt="Zhen Noodle Front" className="product-main-img" />
              <img src="/back.jpeg" alt="Zhen Noodle Back" className="product-secondary-img" />
            </div>
          ...
          <div className="product-hero__info reveal">
            <div className="product-label">Premium Quality Noodles</div>
            <h1 className="product-name">Zhen<br /><em>Noodles</em></h1>
            <p className="product-sub">
              Premium noodles crafted with a perfect blend of wheat and maida for authentic taste and texture.
            </p>
            ...
            <div className="price-row">
              <div className="price-block">
                ...
                <span className="price-val">₹80</span>
                <span className="price-per">/ 500g pack</span>
              </div>
              <div className="price-incl">Incl. all taxes</div>
            </div>

            {/* Key attributes */}
            <div className="attr-row">
              {[
                { icon: '⚖️', label: '500g', sub: 'Net Weight' },
            ...
            <div className="trust-row">
              {['FSSAI Licensed', 'No Preservatives', 'Restaurant Grade', 'Premium Quality'].map((t, i) => (
            ...
            <div className="tab-content reveal">
              <div className="specs-wrap">
                {[
                  ...
                  { label: 'M.R.P.', value: '₹80' },
                  { label: 'Price Per gram', value: '₹0.16' },
            ...
            <div className="tab-content reveal">
              <div className="nutrition-wrap">
                <div className="nut-header">
                  ...
                  <span className="nut-serving">Per 100g serving</span>
                </div>
                <div className="nut-rings">
                  <NutritionRing value={341} label="Calories (kcal)" color="#B8922A" max={600} />
                  <NutritionRing value={73} label="Carbs (g)" color="#D4AD52" max={100} />
                  <NutritionRing value={10} label="Protein (g)" color="#8A6C18" max={30} />
                  <NutritionRing value={5.8} label="Fat (g)" color="#C9A85C" max={10} />
                </div>
                <div className="nut-table">
                  {[
                    { name: 'Energy', val: '341 kcal' },
                    { name: 'Total Carbohydrates', val: '73.00g' },
                    { name: 'Sugar', val: '10.00g' },
                    { name: 'Total Protein', val: '10.00g' },
                    { name: 'Total Fat', val: '5.80g' },
                    { name: 'Saturated Fat', val: '0.00g' },
                    { name: 'Trans Fat', val: '0.00g' },
                  ].map((n, i) => (
                ...
                <p className="nut-disclaimer">* Typical values per 100g. Actual nutritional content may vary slightly by batch.</p>
              </div>
            </div>
          )}
        </div>
      ...
      <section className="cta-strip reveal">
        <div className="container cta-strip-inner">
          <div className="cta-strip-text">
            <div className="cta-strip-tag">Get In Touch</div>
            <h2>Start Your <em>ZHEN</em> Journey</h2>
            <p>Whether you're interested in distribution or have questions about our products, we're here to help.</p>
          </div>
          <div className="cta-strip-actions">
            <a href={WA_URL} target="_blank" rel="noopener noreferrer" className="btn btn--primary btn--large">WhatsApp Enquiry</a>
